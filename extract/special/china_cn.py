...
# 该类提取中国网的相关信息：http://www.china.com.cn（限新闻中心, 其余通过common方法）
class ChinaCnExtract(object):

    def __init__(self):
        self.title_xpath = "//h1/text()"
        self.publishedtime_xpath = "//span[@id='pubtime_baidu']/text()"
        self.content_xpath = "//div[@id='artbody']//p/text()"
...
if __name__ == '__main__':
    item = Item()
    url = 'http://news.china.com.cn/2014-08/08/content_33186454.htm'
