...
# 该类提取中国地震局（网站）相关信息：http://www.cea.gov.cn/
class CeaExtract(object):

    def __init__(self):
        self.title_xpath = "//div[@class='detail_main_right_conbg_tit']/div[1]/text()"
        self.publishedtime_xpath = "//div[@class='detail_main_right_conbg_tit']/div[3]/text()"
        self.content_xpath = "//div[@class='detail_main_right_conbg_con']//text()"
...
if __name__ == '__main__':
    item = Item()
    url = 'http://www.cea.gov.cn/publish/dizhenj/464/478/20140807085249557322083/'
